...
internal class PurchaseTokenApiImpl(log: Kermit, config: AdLibertasConfig) : PurchaseTokenApi {
    ...
    override suspend fun postPurchaseToken(purchaseToken: PurchaseToken): HttpResponse {
        log.d { "Sending receipt $purchaseToken" }
        return client.post {
            receipts(PurchaseToken.path)
            body = purchaseToken
        }
    }
